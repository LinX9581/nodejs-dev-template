...
if gcloud artifacts repositories describe $AR_PROJECT_NAME --location=asia &>/dev/null; then
    echo "Artifact Registry repository '$AR_PROJECT_NAME' already exists, skipping creation."
else
